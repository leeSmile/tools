...
//
//
//  Created by guoyaoyuan on 14-10-8.
//  Copyright (c) 2014 live Interactive. All rights reserved.
//

#import "LFNSObject+Add.h"
#import "LFCategoryMacro.h"
#import <objc/objc.h>
#import <objc/runtime.h>


@implementation NSObject (LFAdditions)
...
#define case_size(_size_) \
    ...
    [inv setArgument:&arg atIndex:index]; \
            ...
            case_size(61) case_size(62) case_size(63) case_size(64)
                ...
                NSLog(@"LFKit performSelectorWithArgs unsupported type:%s (%lu bytes)",
